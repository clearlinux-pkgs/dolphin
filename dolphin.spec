...
Version  : 25.04.1
Release  : 105
URL      : https://download.kde.org/stable/release-service/25.04.1/src/dolphin-25.04.1.tar.xz
Source0  : https://download.kde.org/stable/release-service/25.04.1/src/dolphin-25.04.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/25.04.1/src/dolphin-25.04.1.tar.xz.sig
...
%setup -q -n dolphin-25.04.1
cd %{_builddir}/dolphin-25.04.1
pushd ..
cp -a dolphin-25.04.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1747105415
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libdolphinprivate.so.25.04.1
/V3/usr/lib64/libdolphinvcs.so.25.04.1
...
/usr/lib64/libdolphinprivate.so.25.04.1
/usr/lib64/libdolphinprivate.so.6
/usr/lib64/libdolphinvcs.so.25.04.1
