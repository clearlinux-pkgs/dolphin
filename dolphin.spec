...
Source0  : https://download.kde.org/stable/release-service/24.05.1/src/dolphin-24.05.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.05.1/src/dolphin-24.05.1.tar.xz.sig
...
%setup -q -n dolphin-24.05.1
cd %{_builddir}/dolphin-24.05.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1718399976
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libdolphinprivate.so.24.05.1
/V3/usr/lib64/libdolphinvcs.so.24.05.1
...
/usr/lib64/libdolphinprivate.so.24.05.1
/usr/lib64/libdolphinprivate.so.6
/usr/lib64/libdolphinvcs.so.24.05.1
