...
Version  : 22.08.0
Release  : 66
URL      : https://download.kde.org/stable/release-service/22.08.0/src/dolphin-22.08.0.tar.xz
Source0  : https://download.kde.org/stable/release-service/22.08.0/src/dolphin-22.08.0.tar.xz
...
%prep
%setup -q -n dolphin-22.08.0
cd %{_builddir}/dolphin-22.08.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1661543793
mkdir -p clr-build
pushd clr-build
