...
%prep
%setup -q -n dolphin-24.02.0
cd %{_builddir}/dolphin-24.02.0
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libdolphinprivate.so.24.02.0
/V3/usr/lib64/libdolphinvcs.so.24.02.0
...
/usr/lib64/libdolphinprivate.so.24.02.0
/usr/lib64/libdolphinprivate.so.6
/usr/lib64/libdolphinvcs.so.24.02.0
