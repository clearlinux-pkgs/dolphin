...
Version  : 24.08.0
Release  : 96
URL      : https://download.kde.org/stable/release-service/24.08.0/src/dolphin-24.08.0.tar.xz
Source0  : https://download.kde.org/stable/release-service/24.08.0/src/dolphin-24.08.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.08.0/src/dolphin-24.08.0.tar.xz.sig
...
%setup -q -n dolphin-24.08.0
cd %{_builddir}/dolphin-24.08.0
pushd ..
cp -a dolphin-24.08.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1724517709
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libdolphinprivate.so.24.08.0
/V3/usr/lib64/libdolphinvcs.so.24.08.0
...
/usr/lib64/libdolphinprivate.so.24.08.0
/usr/lib64/libdolphinprivate.so.6
/usr/lib64/libdolphinvcs.so.24.08.0
