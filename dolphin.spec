...
Source0  : https://download.kde.org/stable/release-service/23.08.3/src/dolphin-23.08.3.tar.xz
Source1  : https://download.kde.org/stable/release-service/23.08.3/src/dolphin-23.08.3.tar.xz.sig
...
%prep
%setup -q -n dolphin-23.08.3
cd %{_builddir}/dolphin-23.08.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1699564557
mkdir -p clr-build
pushd clr-build
...
/V3/usr/lib64/qt5/plugins/dolphin/kcms/kcm_dolphinviewmodes.so
/V3/usr/lib64/qt5/plugins/kf5/parts/dolphinpart.so
...
/usr/lib64/qt5/plugins/dolphin/kcms/kcm_dolphingeneral.so
/usr/lib64/qt5/plugins/dolphin/kcms/kcm_dolphinnavigation.so
/usr/lib64/qt5/plugins/dolphin/kcms/kcm_dolphinviewmodes.so
