...
Source0  : https://download.kde.org/stable/release-service/24.02.1/src/dolphin-24.02.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.02.1/src/dolphin-24.02.1.tar.xz.sig
...
%prep
%setup -q -n dolphin-24.02.1
cd %{_builddir}/dolphin-24.02.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1711071709
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libdolphinprivate.so.24.02.1
/V3/usr/lib64/libdolphinvcs.so.24.02.1
...
/usr/lib64/libdolphinprivate.so.24.02.1
/usr/lib64/libdolphinprivate.so.6
/usr/lib64/libdolphinvcs.so.24.02.1
